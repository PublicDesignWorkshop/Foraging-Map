            ...
            var slider = this,
                ...
                options = {
                    ...
                    formatLabel: function(value) {
                        if (slider.options.step == 60 * 60 * 1000) {
                            return this.prefix + moment(value).format("MMMYYYY") + this.suffix;
							//return this.prefix + new Date(value).toString('MMMyyyy') + this.suffix;
						} else {
        ...
        float: function( settings ) {
            ...
            var options = {
                ...
                formatLabel: function(value) {
                    if (slider.options.step == 60 * 60 * 1000) {
                        return this.prefix + moment(value).format("MMMYYYY") + this.suffix;
						//return this.prefix + new Date(value).toString('MMMd,yyyy') + this.suffix;
					} else {
						return this.prefix + value + this.suffix;
					}
                }
